            ...
            >
              ...
              <div className="space-y-6">
                ...
                <motion.div
                  ...
                  className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-white/95 backdrop-blur-xl border-2 border-[#006994]/30 shadow-lg hover:shadow-xl transition-shadow"
                >
                  <Sparkles className="w-4 h-4 text-[#006994]" />
                ...
                >
                  <span className="text-[#0F172A]">Welcome to Your</span>
                  <br />
                  <span className="bg-gradient-to-r from-[#006994] via-[#4F8CFF] to-[#C7B9FF] bg-clip-text text-transparent">
                ...
                >
                  Sign in to explore places that align with who you are
                </motion.p>
