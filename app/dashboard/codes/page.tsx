...
import { Sparkle, TrendingUp, Lightbulb, ArrowLeft, Heart } from "lucide-react";
import Link from "next/link";

/* ============================================================================
   YOUR CODES PAGE — Complete with all 20 mythical codes
...
const CODE_DATA: Record<string, {
  ...
  "ashcaller": {
    ...
    challenges: ["Destructive tendencies", "Intensity overwhelming others"]
  },
  "horizonkin": {
    name: "HorizonKin",
