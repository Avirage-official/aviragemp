  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-2 bg-black">
        ...
        <AnimatePresence mode="wait">
          ...
          >
            <div 
              ...
              style={{ backgroundImage: `url(/images/onboarding/business-${step}.jpg)` }}
            />
      ...
      <div className="flex items-center justify-center px-6 py-12 relative">
        <div className="absolute inset-0 bg-gradient-to-br from-slate-950 via-purple-950/20 to-slate-950 -z-10"></div>
            ...
            >
              ...
              <div className="bg-white/[0.02] backdrop-blur-xl border border-white/10 rounded-2xl p-8">
                {step === 1 && (
                  <input
                    ...
                    className="w-full bg-white/5 border border-white/20 text-white px-6 py-4 rounded-xl text-lg focus:border-purple-500 focus:outline-none transition-all placeholder:text-gray-600"
                ...
                {step === 2 && (
                  <textarea
                    ...
                    className="w-full bg-white/5 border border-white/20 text-white px-6 py-4 rounded-xl text-lg focus:border-purple-500 focus:outline-none transition-all min-h-[150px] resize-none placeholder:text-gray-600"
              ...
              <div className="flex gap-4">
                ...
                <button
                  ...
                  className="flex-1 bg-gradient-to-r from-purple-600 to-purple-500 hover:from-purple-500 hover:to-purple-400 text-white px-6 py-4 rounded-xl font-semibold flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-300 shadow-lg shadow-purple-500/20"
                >
